...
The application reads its database connection string and JWT signing key from secret providers instead of its tracked appsettings files. `BrettsDbConnection` is used for the bretts-services database.
